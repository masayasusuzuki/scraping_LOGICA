...
| No. | 項目名 | データ型 | 備考 |
|:---:|:---|:---|:---|
| 1 | **施設名** | 文字列 | クリニック名・病院名 |
| 2 | **代表者名** | 文字列 | 院長・理事長・代表者（詳細ページから取得） |
| 3 | **住所** | 文字列 | 勤務地住所（詳細ページから取得、一覧ページでは地域のみ） |
| 4 | **WebサイトURL** | 文字列 | 求人詳細ページのURL |
| 5 | **電話番号** | 文字列 | 詳細ページ + Web検索で取得 |
| 6 | **メールアドレス** | 文字列 | 詳細ページ + Web検索で取得 |
| 7 | **事業内容** | 文字列 | 求人タイトル + 主な施術内容 |

##### 3.1.2. とらばーゆ（東京・神奈川・千葉・埼玉）
| No. | 項目名 | データ型 | 備考 |
|:---:|:---|:---|:---|
